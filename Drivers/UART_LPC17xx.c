...
#endif
#if (RTconst E_UART4_SCLK_PIN_EN == 1)
static PIN USART4_pin_clk = { RTE_UART4_SCLK_PORT, RTE_UART4_SCLK_BIT };
#endif
...
#if defined (LPC175x_6x)
    PIN_Configure(usart->pins.pin_clk->Portnum, usart->pins.pin_clk->Pinnum, val, 0U, 0U);
#elif defined (LPC177x_8x)
